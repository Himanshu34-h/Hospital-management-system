      ...
      <Container maxWidth="md">
          ...
          <Grid item xs={12} sm={6}>
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="body1">
                Email: Muzaffarnagarhospital@gmail.com
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} sm={6}>
          ...
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12} sm={6}>
              <Box display="flex" alignItems="center">
                <LocationOn sx={{ mr: 1 }} />
                <Typography variant="body1">
                  opposite Raj Public Inter College, Khanupur, Mansurpur, Uttar Pradesh 251203
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6}>
        ...
        <Box mt={4}>
          ...
          <Box height={400} mt={2}>
            ...
            <iframe src="https://www.google.com/maps/place/Muzaffarnagar+Hospital/data=!4m2!3m1!1s0x0:0x254096996b1d3be7?sa=X&ved=1t:2428&ictx=111" width="850" height="400"  loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </Box>
        </Box>
